...
def create_training_options():
    ...
    parser.add_argument("--backdoor-infer", action="store_true",             help="determine if backdoor for inference")
    ...
    parser.add_argument("--rightbottom",    action="store_true",             help="trigger location")
    parser.add_argument("--rightabove",     action="store_true",             help="trigger location")
    parser.add_argument("--leftabove",      action="store_true",             help="trigger location")
...
def main(opt):
    ...
    # backdoor_dataset = imagenet.build_backdoor_dataset(opt, log, train=True)
